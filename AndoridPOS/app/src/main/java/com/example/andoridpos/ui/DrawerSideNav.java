...
public class DrawerSideNav extends DrawerLayout {

    private static final String TAG = DrawerSideNav.class.getSimpleName();
    ...
    public DrawerSideNav(Context context) {
        super(context);
        init(context, null, 0);

    }

    public DrawerSideNav(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);

    }

    public DrawerSideNav(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        addDrawerListener(new DrawerListener() {
            ...
            public void onDrawerSlide(View drawerView, float slideOffset) {
                DrawerSideNav.this.drawerView = drawerView;
...
//    }
    ...
    private void updateSlideOffset(View drawerView, float slideOffset) {
        ...
        //frameLayout.animate().translationX(this.getX() + (this.getWidth() / 10)+ (this.getWidth() / 2) ).translationY(250).setDuration(500).start();


        //frameLayout.animate().translationX(this.getX()).translationY(this.getY()).setDuration(500).start();
